...
_EXCEL_CAMPOS = [
    ...
    ("contas_receber",             "Contas a receber — Total (se não detalhar)",     "currency"),
    ...
    (None, "QD — QUANTO DEVO", None),
    ("contas_pagar",               "Contas a pagar — Total (se não detalhar)",       "currency"),
    ...
    ("dividas",                    "Dívidas — Total (se não detalhar)",              "currency"),
