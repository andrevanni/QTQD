...
- **Service Worker:** versão atual `qtqd-v10` em `frontend_cliente/sw.js`. Ao fazer mudanças que devem invalidar cache, incrementar a versão.
...
QTQD/
  frontend_cliente/       Portal do cliente
    ...
    sw.js                 Service Worker (cache qtqd-v10)
...
#### Frontend
- `frontend_cliente/excesso_critico.js` — módulo isolado, expõe `window.QTQD_EXCESSO.init()`
...
- `shared/api_client.js` — métodos `getExcessoLimites`, `putExcessoLimites`, `calcularExcesso`, `aplicarExcesso`
