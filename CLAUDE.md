...
- **Service Worker:** versão atual `qtqd-v13` em `frontend_cliente/sw.js`. Ao fazer mudanças que devem invalidar cache, incrementar a versão.
...
QTQD/
  frontend_cliente/       Portal do cliente
    ...
    sw.js                 Service Worker (cache qtqd-v13)
