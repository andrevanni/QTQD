...
const _ss=k=>sessionStorage.getItem(k)||localStorage.getItem(k)||'';
const getRuntimeConfig=()=>{const cfg=window.QTQD_APP_CONFIG||{mode:"simulation",tenantId:""};const storedTenant=_ss("qtqd_tenant_id_v1");const hasJwt=!!_ss("qtqd_jwt_v1");if(hasJwt&&storedTenant)return{...cfg,mode:"api",tenantId:storedTenant};return cfg};
...
const hasTenant=!!_ss("qtqd_tenant_id_v1");const hasJwt=!!_ss("qtqd_jwt_v1");if(hasTenant&&!hasJwt){showLoginScreen();return}
